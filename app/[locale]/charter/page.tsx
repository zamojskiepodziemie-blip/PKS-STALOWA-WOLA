        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
          <div>
            ...
            <div className="mt-10 card p-6">
              <h3 className="font-display text-xl font-semibold mb-4">{dict.charterPage.includes}</h3>
              <ul className="space-y-3">
                {dict.charterPage.includesItems.map((item) => (
                  <li key={item} className="flex items-center gap-3 text-sm">
                    <span className="w-6 h-6 rounded-full bg-emerald-50 dark:bg-emerald-950/50 grid place-items-center text-emerald-600">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {[
                ...
                <div key={s.l} className="card p-4 text-center">
                  <div className="font-display text-2xl font-bold text-brand-600">{s.v}</div>
